...
every theme and level (93 entries), French, German and Spanish two,
Slovene one.
Current version:
...
- **Pick language, theme, level; click "Create text."** The app shows a
  ...
  theme and level have several texts (every English cell has at least three, every French, German and Spanish cell two), a
...
topic rather than drawn for the text (166 of 268 verified, the rest
