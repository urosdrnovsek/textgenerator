...
theme and level (stories, animal facts and around the world done, two themes in progress). Current version: `0.8.1-rc.1` — a release
...
- **Pick language, theme, level; click "Create text."** The app shows a
  ...
  theme and level have several texts (three English themes have three each), a
