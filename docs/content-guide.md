...
- **English:** 80 entries — three per theme × level cell, four in the
  five story cells. The 25 below plus fifty original texts (ten per
  ...
  `mountain_camping`), animals, science, and a few nature and
  around-the-world cells to follow.
...
- **Images:** 78 of 180 `verified` (the four illustrations generated for
